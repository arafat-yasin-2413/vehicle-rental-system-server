...
const addNewVehicle = async (payload: Record<string, unknown>) => {
    ...
    // TODO: To verify field values according to requirements
...
const updateVehicleById = async (vehicle_name: string, type: string, registration_number: string, daily_rent_price: number, availability_status: string, id: string) => {
